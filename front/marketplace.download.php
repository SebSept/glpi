...
// This endpoint is reached through a regular link, so the redirection to the prompt
// and the replay of the download request both happen in the browser.
(new Plugin())->checkGlobal(UPDATE);
